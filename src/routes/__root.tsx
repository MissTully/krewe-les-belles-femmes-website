...
const APP_NAME = "Krewe of Les Belles Femmes";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Krewe of Les Belles Femmes — a Tampa Bay sisterhood of women celebrating Truth, Beauty, Freedom, and Love. Est. 2002.",
      },
      { name: "theme-color", content: "#4B111D" },
    ],
    links: [
