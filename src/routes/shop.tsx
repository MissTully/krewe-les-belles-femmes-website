  ...
  return (
    <article className="pb-24">
      ...
      <p className="wrap mt-8 max-w-2xl text-sm text-muted">
        Shipping is $8, or complimentary at $70. The krewe confirms each order
        by email and sends a Square invoice; nothing is charged until you say
        yes. Prefer the original storefront?{" "}
        <a
          href={links.shop}
          target="_blank"
          rel="noreferrer"
          className="font-semibold text-cabaret"
        >
    ...
    <article className="panel overflow-hidden">
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="mt-2 flex flex-wrap items-baseline justify-between gap-3">
          ...
          <p className="font-display text-2xl text-cabaret">
            {money(product.price)}
          </p>
        </div>
